      ...
      <div class="box">
        <div class="inner-box">
          ...
          <div class="forms-wrap">
            <form action="checkdesignersignin" method="post" autocomplete="off" class="sign-in-form">
              ...
              <div class="heading">
               <h2 style="font-family: 'Poppins', sans-serif; font-weight: bold;">Welcome Back</h2>
...
<input type="submit" value="Sign In" class="sign-btn" style="font-weight: bold;" />
            ...
            <form action="insertdesigner" method="POST" autocomplete="off" class="sign-up-form">
             <a href="index" class="back-btn" style="font-weight: bold;">Back</a>
  ...
  <div class="heading">
    <h2 style="font-family: 'Poppins', sans-serif;">Get Started</h2>
  ...
  <input
    ...
    oninvalid="this.setCustomValidity('Please enter a valid Gmail address (e.g., example@gmail.com)')"
  />
  <label>Email</label>
    ...
    <input type="submit" value="Sign Up" class="sign-btn" style="font-weight: bold; "/>
      ...
      <a href="#">Privacy Policy</a>
          ...
          <div class="carousel">
            <div class="images-wrapper">
              <img src="https://img.freepik.com/free-vector/real-estate-deals-agent-client-shaking-hands-people-buying-building-houses-market-growth-flat-vector-illustration-investment-construction-rent-property-concept_74855-22534.jpg" class="image img-1 show" alt="" />
              <img src="https://t4.ftcdn.net/jpg/04/82/12/93/360_F_482129392_oyRFboFmhUrhbLRkbMoQV2RH1oyeSZsl.jpg" class="image img-2" alt="" />
              <img src="https://media.istockphoto.com/id/1263319152/vector/woman-holding-keys-from-house-for-sale-and-smiling.jpg?s=612x612&w=0&k=20&c=P3HPAsY-YxeqRLfLzX0l1cnqGZYtuISgfCmbG1NRfNg=" class="image img-3" alt="" />
            </div>

            <div class="text-slider">
  <div class="text-wrap">
    <div class="text-group">
      <h2 class="title">Add value to homes</h2>
