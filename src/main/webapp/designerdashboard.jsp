  ...
  <header id="header" class="header fixed-top">
    ...
    <div class="branding d-flex align-items-center">
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="designerdashboard" class="logo d-flex align-items-center">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="designerdashboard" class="active">Home</a></li>
            <li class="dropdown"><a href="#"><span>Manage</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
                <li><a href="designer_consultations">Users</a></li>
            ...
            <li class="dropdown">
              <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <!-- Use EL to access session and designer's name -->
                Welcome, ${sessionScope.designer.name} <i class="bi bi-chevron-down toggle-dropdown"></i>
              </a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="desprofile">Profile</a></li>
